export default {
  ...
  'newSession.directoryPicker.filterPlaceholder': 'Filter directories…',
  'newSession.directoryPicker.showHidden': 'Dotfiles',
  'newSession.directoryPicker.hideHidden': 'Dotfiles',
  'newSession.directoryPicker.noMatch': 'No directories match the filter.',
  ...
  'newSession.reasoningEffort.default': 'Default',
  'newSession.reasoningEffort.low': 'Low',
  'newSession.reasoningEffort.medium': 'Medium',
  'newSession.reasoningEffort.high': 'High',
  'newSession.reasoningEffort.xhigh': 'XHigh',
  'newSession.effort.auto': 'Auto',
  'newSession.effort.low': 'Low',
  'newSession.effort.medium': 'Medium',
  'newSession.effort.high': 'High',
  'newSession.effort.max': 'Max',
  'newSession.effort.xhigh': 'XHigh',
  ...
  'settings.display.baseFontSize': 'Base Font Size',
  'settings.display.baseFontSize.small': 'Small',
  'settings.display.baseFontSize.medium': 'Standard',
  'settings.display.baseFontSize.large': 'Large',
  'settings.display.baseFontSize.extraLarge': 'Extra Large',
  ...
  'notify.git.amendOk': 'Commit message updated',
  'notify.git.revertOk': 'Commit reverted',
  'notify.git.stashApplied': 'Stash applied',
  'notify.git.stashDropped': 'Stash dropped',
  'notify.refreshed': 'Refreshed',
  'git.uncommit': 'Uncommit',
  'git.editMessage': 'Edit Message',
  'git.revert': 'Revert',
  'git.squashMerge': 'Squash merge (combine all commits into one)',
  'git.showDiffPreview': 'Show diff preview',
  'git.hideDiffPreview': 'Hide diff preview',
  'git.mergeConflict': 'Merge would cause conflicts',
  'git.mergeConflictDetected': 'Conflict detected! Merge cannot proceed automatically:',
  'git.checkingConflicts': 'Checking conflicts…',
  ...
  'dialog.git.amend.title': 'Edit Commit Message',
  'dialog.git.amend.confirm': 'Update',
  'dialog.git.amend.confirming': 'Updating…',
  'dialog.git.revert.title': 'Revert Commit',
  'dialog.git.revert.description': 'Create a reverse commit for "{short}: {subject}"? This will undo the changes without rewriting history.',
  'dialog.git.revert.confirm': 'Revert',
  'dialog.git.revert.confirming': 'Reverting…',
  ...
  'git.expandCommitBody': 'Click to expand commit message',
  ...
  'git.searchCommitsTagged': 'keyword: author: hash: or plain text',
