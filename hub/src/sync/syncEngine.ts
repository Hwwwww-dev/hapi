...
export class SyncEngine {
    ...
    async spawnSession(
        ...
        return await this.rpcGateway.spawnSession(machineId, directory, agent, model, modelReasoningEffort, yolo, sessionType, worktreeName, resumeSessionId, sessionId)
    }
    ...
    async gitStashApply(sessionId: string, options: { cwd?: string; index?: number }): Promise<RpcCommandResponse> {
        return await this.rpcGateway.gitStashApply(sessionId, options)
    }
